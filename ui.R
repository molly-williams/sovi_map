...
vars <- c(
    ...
    "Children" = "% popn. under age 5",
    "Race and ethnicity" = "% of households with >0 non-white people",
    "Older adults living alone" = "% single-person households > age 64",
    "Educational attainment" = "% of adults 25+ without GED/diploma",
    "Disability" = "% of households that include someone with a disability",
    "Tenancy" = "% of rented housing units",
    "Vehicle access" = "% of households with no vehicle access",
    "Linguistic isolation" = "% of households with limited English proficiency",
    "Poverty" = "% of households with income <200% of the federal poverty line",
    "Low birth weight" = "% of babies born at low birth weight",
    "Asthma" = "Asthma ER visits per 10k",
    "Cardiovascular disease" = "Heart-attack ER visits per 10k",
    "Health insurance" = "% uninsured households",
    "Food insecurity" = "Region of low food access"
)
           ...
           tabPanel("Interactive map",
                    div(class="outer",
                        ...
                        absolutePanel(id = "controls", class = "panel panel-default", fixed = TRUE,
                                      ...
                                      h4("Instructions:"),
                                      tags$div(
                                          "1. Select the overall vulnerability rating or one of 14 indicators from the dropdown menu to view data by census block group.",
                                          tags$br(),
                                          tags$br(),
                                          "2. Click a region on the map to get more information about that census block group.",
                                          tags$br(),
                                          tags$br(),
                                          "3. Toggle layers on and off in the upper right corner and hover over the map for additional information.",
                                          tags$br(),
                                          tags$br(),
                                          "4. Enter latitude and longitude values below to set a pin on the map.",
                                          tags$a("Get a lat/long from an address here.", href="https://www.latlong.net/convert-address-to-lat-long.html", target="_blank"),
                                          tags$br(),
                                          tags$br(),
                                          "5. Copy the block group ID from the popup or enter a zip code into the search bar in the Data Explorer tab to filter data to that region."
                                      ),
